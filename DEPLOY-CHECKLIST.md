# Deploy Checklist — Nara System V3.4.6

1. Backup/review repository production saat ini.
2. Replace source dengan isi paket V3.4.6.
...
Migration terakhir tetap `0019_workflow_inbox.sql`; V3.4.6 tidak menambah schema baru.
...
- V3.4.6 tidak menambah migration baru; migration terakhir tetap `0019_workflow_inbox.sql`.
