...
export default {
  async fetch(request, env) {
    ...
    if (path === "/app-build.json") return json({ok:true,appVersion:APP_VERSION,service:SERVICE_NAME,architecture:"worker+d1+r2+assets",workflow:"v3.1.5-qc-function-fix"});
