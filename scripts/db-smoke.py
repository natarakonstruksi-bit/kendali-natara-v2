...
up.execute("insert into app_records values(?,?,?,datetime('now'))",('projects','qa-project',json.dumps({'name':'QA Existing Project','pmUserId':'qa-user'})))
apply(up)
...
print('Upgrade preservation OK: existing user/project preserved')
